...
public class AddFuncionarioDepois extends javax.swing.JFrame {

    private TelaDeEficienciaDepois telaDeEficiencia;
    private TecladoDepois teclado;
    
    public AddFuncionarioDepois(TelaDeEficienciaDepois telaDeEficiencia) {
        initComponents();
    ...
    teclado = new TecladoDepois(this);
