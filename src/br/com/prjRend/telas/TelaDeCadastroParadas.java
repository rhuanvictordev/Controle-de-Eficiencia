...
public class TelaDeCadastroParadas extends javax.swing.JInternalFrame {

    Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;

    public TelaDeCadastroParadas() {
        initComponents();
    ...
    public void adicionarPausa() {
        ...
        String sql = "insert into efi_pausas (pausa_nome, setor_id) values (?,?)";
        ...
        try {
            ...
            if (txtPausaNome.getText().isEmpty() || lblIdSetor.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatórios!");
            } else {
                int adicionado = pst.executeUpdate();
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Pausa criada!");
                    int o = JOptionPane.showConfirmDialog(null, "Deseja continuar adicionando pausas no mesmo setor?", "Atenção", JOptionPane.YES_NO_OPTION);
                    if (o == JOptionPane.YES_OPTION) {
                        txtPausaNome.setText(null);
                        txtPausasPesquisar.setText(null);
                        lblIdPausa.setText(null);
                        pesquisarPausas();
                        txtPausaNome.requestFocus();
                    } else {
                        txtPausaNome.setText(null);
                        txtPausasPesquisar.setText(null);
                        lblIdPausa.setText(null);
    ...
    public void pesquisarPausas() {
        ...
        String sql = "select setor_nome AS Setor, pausa_nome AS Nome from efi_pausas JOIN efi_setores ON efi_pausas.setor_id = efi_setores.setor_id where pausa_nome like ? and setor_nome like ?";
    ...
    public void setar_campos() {
        ...
        String setorNome = tblPausas.getModel().getValueAt(setar, 0).toString();
        String pausaNome = tblPausas.getModel().getValueAt(setar, 1).toString();
        
        String sqlIdPausa = "SELECT efi_pausas.pausa_id FROM efi_pausas JOIN efi_setores ON efi_pausas.setor_id = efi_setores.setor_id where setor_nome = ? and efi_pausas.pausa_nome = ?";
        String sqlIdTrabalho = "SELECT efi_pausas.setor_id FROM efi_pausas JOIN efi_setores ON efi_pausas.setor_id = efi_setores.setor_id where setor_nome = ? and efi_pausas.pausa_nome = ?";
        
        txtPausaNome.setText(pausaNome);
    ...
    public void editarPausa() {
        ...
        String sql = "update efi_pausas set pausa_nome = ?, setor_id = ? where pausa_id = ?";
        try {
            pst = conn.prepareStatement(sql);
            pst.setString(1, txtPausaNome.getText().toUpperCase());
            pst.setString(2, lblIdSetor.getText());
            pst.setString(3, lblIdPausa.getText());
    ...
    public void removerTrabalho() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            if (lblIdSetor.getText().isEmpty()) {
                ...
                String sql = "delete from efi_pausas where pausa_id = ?";
                try {
                    conn = ModuloConexao.conector();
                    pst = conn.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Banco de Pausas não Planejadas");
        ...
        jLabel3.setText("Cadastro de Pausas não Planejadas");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtSetorPesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPausasPesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeCadastroParadas().setVisible(true);
            }
        });
    }
