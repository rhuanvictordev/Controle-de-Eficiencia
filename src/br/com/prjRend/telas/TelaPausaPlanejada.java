...
public class TelaPausaPlanejada extends javax.swing.JFrame {
    ...
    public TelaPausaPlanejada(TelaDeEficiencia te) {
        this.telaDeEficiencia = te;
        initComponents();
    ...
    public void buscarPausas() {
        ...
        String nomeDoSetor = telaDeEficiencia.lblSetorNome.getText();
    ...
    public void obterTempo(){
        ...
        try {
            ...
            pst.setString(1, telaDeEficiencia.lblSetorNome.getText());
   ...
   public void enviarDados(){
       ...
       Double tempoOperacional = Double.valueOf(telaDeEficiencia.txtTempoDesejadoParaProduzir.getText());
       String NomeNovaPausa = novaPausaString;
       Double TempoNovaPausa = Double.valueOf(tempoPausa);
       
       for (PausaPlanejada p : telaDeEficiencia.pausas){
       ...
       if(pausaExiste == false){
           ...
           double tempoDecorrido = telaDeEficiencia.tempoTotal;
           
           if((tempoDecorrido + TempoNovaPausa) > tempoOperacional){
               JOptionPane.showMessageDialog(null, "Tempo restante insuficiente");
               return;
           }else{
           telaDeEficiencia.txtTempoDesejadoParaProduzir.setText(novoTempoOperacional);
           }
           
           /////////////////////////////////////////////////////////////////////// validar se tem tempo suficiente
           PausaPlanejada pa = new PausaPlanejada(NomeNovaPausa);
           telaDeEficiencia.pausas.add(pa);
           this.dispose();
       }
       
       telaDeEficiencia.calcularEficiencia();
       pausaExiste = false;
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPausaPlanejada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
